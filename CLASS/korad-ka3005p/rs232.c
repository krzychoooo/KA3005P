...
int RS232_OpenComport(int comport_number, int baudrate, const char *mode)
{
  ...
  switch(baudrate)
  {
    case     110 : strlcpy(mode_str, "baud=110",8);
                   break;
    case     300 : strlcpy(mode_str, "baud=300",8);
                   break;
    case     600 : strlcpy(mode_str, "baud=600",8);
                   break;
    case    1200 : strlcpy(mode_str, "baud=1200",9);
                   break;
    case    2400 : strlcpy(mode_str, "baud=2400",9);
                   break;
    case    4800 : strlcpy(mode_str, "baud=4800",9);
                   break;
    case    9600 : strlcpy(mode_str, "baud=9600",9);
                   break;
    case   19200 : strlcpy(mode_str, "baud=19200",10);
                   break;
    case   38400 : strlcpy(mode_str, "baud=38400",10);
                   break;
    case   57600 : strlcpy(mode_str, "baud=57600",10);
                   break;
    case  115200 : strlcpy(mode_str, "baud=115200",11);
                   break;
    case  128000 : strlcpy(mode_str, "baud=128000",11);
                   break;
    case  256000 : strlcpy(mode_str, "baud=256000",11);
                   break;
    case  500000 : strlcpy(mode_str, "baud=500000",11);
                   break;
    case 1000000 : strlcpy(mode_str, "baud=1000000",12);
                   break;
    default      : printf("invalid baudrate\n");
                   return(1);
                   break;
